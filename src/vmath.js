	...
	return 
		Class.create({
			...
			distanceFromLine : function(P, A, B) {
				...
				var l2 = this.distanceSquared(A, B); // i.e. |w-v|^2 - avoid
				// a sqrt
				if (l2 == 0)
				...
				if (t < 0)
					return this.distance(P, B); // Beyond the 'v' end of the
				// segment
				else if (t > 1)
					return this.distance(P, A); // Beyond the 'w' end of the
				// segment
